...
// Check that a machine can actually FETCH the panoramas GeoGuesser serves.
//
...
// resolved to 127.0.0.1 there while the remote backend fetched the same image fine - so "it works here" is
